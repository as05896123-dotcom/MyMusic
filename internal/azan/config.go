...
// --- [ 2. الأدعية (تعديل الإيموجي) ] ---
// تم استبدال الإيموجي القديم بـ ⭐🧚💫🩵💞
...
type ChatAzanSettings struct {
	...
	DuaActive      bool            `bson:"dua_active"`      // تم إضافة هذا الحقل
	NightDuaActive bool            `bson:"night_dua_active"` // تم إضافة هذا الحقل
...
func GetChatSettings(chatID int64) (*ChatAzanSettings, error) {
	...
	// التأكد من تهيئة الخريطة لتجنب الأخطاء
